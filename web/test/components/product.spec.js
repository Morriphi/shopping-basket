...
const AddButton = require('../../src/components/add-button');
...
describe('Product', () => {
  ...
  it('renders add button in third column', () => {
    expect(shallow(<Product />).find('.col-md-2').contains(<AddButton />)).to.equal(true);
  });
});
